<template>
  ...
  >
    <h2>
      Your account hasn't linked to any brokerage services
    </h2>
    <p>Navigate to Connected Apps to link your account</p>
  </div>
</template>
<script>
...
export default {
  ...
  computed: {
    ...
    hasAlpaca () {
      return this.user.alpacaToken !== 'None' && this.user.alpacaToken !== undefined
    },
    dailyChange () {
